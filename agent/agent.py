...
# The DQN implementation was later changed to this:
# https://ai.stackexchange.com/questions/10203/dqn-stuck-at-suboptimal-policy-in-atari-pong-task
class DQN(nn.Module):

    def __init__(self, actions, frames):
        super(DQN, self).__init__()
        self.action_space = actions
        self.hidden = 512

        self.conv1 = torch.nn.Conv2d(in_channels=frames,
                                     out_channels=32,
                                     kernel_size=8,
                                     stride=4)
        ...
        self.fc2 = torch.nn.Linear(self.hidden, actions)
...
class Agent(object):
    def __init__(self, n_actions = 3, frame_stacks = 3, gamma = 99, batch_size = 32, replay_buffer_size = 50000):
        ...
        self.n_actions = 3
        self.frame_stacks = 3
        self.agent_name = "Todo"  # Pronounced similar to Frodo
    ...
    def _preprocess(self, observation):
        ...
        observation = observation[::2, ::2] # Downsample with half
